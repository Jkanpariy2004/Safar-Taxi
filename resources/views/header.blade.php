    ...
    <div class="container-fluid  py-2 px-lg-5 d-lg-block header">
        <div class="row">
            <div class="col-3 col-lg-6  d-inline-flex align-items-center">
                <a href="/driver"><img src="/assets/img/safar.png" width="80" alt=""></a>
            </div>
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            $userdata = DB::table('driver')->where('mobile', $mobile)->first();
                            ?>
                            ...
                            <a href="/driver" class="dropdown-item has-icon mt-2 {{Request::is('/driver') ? 'active' : '' }}"> <i class="fas fa-home icon"></i> Home </a>
                            <div class="dropdown-divider"></div>
                            @if($userdata)
                            <a href="/driverprofile" class="dropdown-item has-icon {{Request::is('driverprofile') ? 'active' : '' }}"> <i class="far fa-user icon"></i> Show Profile </a>
                            <div class="dropdown-divider"></div>
                            <a href="/driver_logout" class="dropdown-item has-icon text-danger"> <i class="fas fa-sign-out-alt"></i> Logout </a>
                            @else
