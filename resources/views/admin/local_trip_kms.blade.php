...
<div class="card card-outline card-info rounded-0">
	...
	<div class="card-body">
		<form action="local_amt_log" method="post" id="cab-form">
            @csrf
...
<script>
    ...
    checkbox.addEventListener("change", function() {
        ...
        if (this.checked) {
            ...
            let div=' <div class="row city_div mb-5" style="border:1px solid black;background:grey" id="city_div"><div class="form-group col-12 col-lg-12"><label for="place" class="control-label">Destination</label><input name="place[]" id="place" type="text" class="form-control rounded-0"></div><div class="form-group col-6 col-lg-6"><label for="km" class="control-label">KM</label><input name="km[]" id="km" type="text" class="form-control rounded-0" value="" required></div><br><div class="form-group col-6 col-lg-6"><label for="hrs" class="control-label">Total Hrs</label><input name="hrs[]" id="hrs" type="text" class="form-control rounded-0"></div><div class="form-group col-6 col-lg-6"><label for="hatchback" class="control-label">Hatchback</label><input name="hatchback[]" id="hatchback" type="number" class="form-control rounded-0" value="" required></div><br><div class="form-group col-6 col-lg-6"><label for="sedan" class="control-label">Sedan</label><input name="sedan[]" id="sedan" type="number" class="form-control rounded-0" value="" required></div><br><div class="form-group col-6 col-lg-6"><label for="suv" class="control-label">Suv</label><input name="suv[]" id="suv" type="number" class="form-control rounded-0" value="" required></div><br><div class="container"><a id="remove" class="btn removeButton btn-outline-danger">Remove</a></div><br></div>'
