...
<div class="card card-outline card-warning">
	...
	<div class="card-body">
        ...
        <br>
            ...
            <form method="post" action="update_local">
                @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
               ...
               <div class="mb-3">
                <label for="km" class="form-label">Kms</label>
                <input type="text" class="form-control" value="{{$data->km}}" name="km" id="km">
            </div>     
            <div class="mb-3">
                <label for="hrs" class="form-label">Hours</label>
                <input type="text" class="form-control" value="{{$data->hrs}}" name="hrs" id="hrs">
            </div>
